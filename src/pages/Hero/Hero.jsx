...
export default function Hero() {
  const words = [
    ...
    "React.js, Node.js & Flutter Expert",
    "Automation Testing & AI-Powered Workflows",
...
const profile = {
    name: 'Aarav Mody',
    title: 'SDET | Full-Stack Developer | Innovation Enthusiast',
    contact: {
    ...
    education: [
        'B.Tech Computer Engineering - DJSCE (CGPA: 9.20)',
        'B.S. Data Science - IIT Madras (CGPA: 8.0)'
    ],
    skills: [
        'React', 'Node.js', 'Flutter', 'TypeScript',
        'Playwright', 'WebDriverIO', 'AWS', 'Docker',
        'MongoDB', 'PostgreSQL', 'GraphQL', 'FastAPI'
    ],
    experience: [
        'SDET at BrowserStack (Jan-July 2026)',
        'Software Developer at Amaxa Tech (Jan-Dec 2025)'
    ],
    passionateCoder: true,
    quickLearner: true,
    problemSolver: true,
    hireable: function() {
        return (
            this.passionateCoder &&
            this.problemSolver &&
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  SDET & Full-Stack Developer 🚀 | Building robust testing solutions 🔧 |
                  Automating the future with AI-powered workflows 💻✨
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/aaravmody"
