...
import { Send, Phone, MapPin, Mail, Linkedin  } from "lucide-react";
...
export default function Contact() {
 ...
 text-white min-h-screen"
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">aaravmody1@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">+91 7977183376</p>
                  </div>
                </div>
  ...
  <div>
    ...
    <a
      href="https://www.linkedin.com/in/aaravmody/"
      target="_blank"
      rel="noopener noreferrer"
      className="text-gray-400 hover:text-blue-400 transition-colors"
    >
      linkedin.com/in/aaravmody
    </a>
  </div>
</div>
              </div>
